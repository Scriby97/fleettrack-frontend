        ...
        <div className="rounded-lg border-2 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 p-6">
          <div className="flex items-center justify-between">
            ...
            <svg 
              ...
              viewBox="0 0 24 24"
            >
              <path d="M3 19h2v2H1v-3h2v1zm16 0v1h2v3h-4v-2h2v-2zM6 4h8c1.1 0 2 .9 2 2v10H4V6c0-1.1.9-2 2-2zm1 2v4h6V6H7zm11.35 2.13l2.12 2.12c.2.2.2.51 0 .71l-2.12 2.12v5.42c0 1.38-1.12 2.5-2.5 2.5s-2.5-1.12-2.5-2.5v-1.5h1.5c.83 0 1.5-.67 1.5-1.5v-4c0-.83-.67-1.5-1.5-1.5H16V6.48c0-.46.25-.88.65-1.1l.7-.38z"/>
            </svg>
          </div>
        </div>
      )}
