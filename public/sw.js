...
const CACHE_NAME = 'fleettrack-v9';
const STATIC_CACHE_NAME = 'fleettrack-static-v9';
...
// Push event - taegliche Erfassungserinnerung (und ggf. weitere Benachrichtigungen)
self.addEventListener('push', (event) => {
  ...
  const title = data.title || 'FleetTrack';
  const options = {
    body: data.body || '',
...
// Notification-Klick - vorhandenes Fenster fokussieren statt ein neues zu oeffnen
